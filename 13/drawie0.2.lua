...
local function moveToPos(x, y, z, dir)
    -- Ensure A knows its current position; if not, seed from GPS.
...
local function mainLoop()
    ...
    print("=== Drawie v2.2 ? Drawer Sorter ===")
    ...
    -- Ensure A knows starting position *once* on boot
    A.startGPS()
    A.setLocationFromGPS()
